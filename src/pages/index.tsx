...
import aftereffect from '@/../public/aftereffect.png'

// front experience
import react from '@/../public/front/react.png'
import vue from '@/../public/front/Vue.png'
import angular from '@/../public/front/angular.png'
import sass from '@/../public/front/sass.png'
import storybook from '@/../public/front/storybook.png'
import zod from '@/../public/front/zod.png'

// back experience
import azure from '@/../public/back/azure.png'
import nest from '@/../public/back/nest.svg'
import postgreesql from '@/../public/back/postgreesql.png'
import postman from '@/../public/back/postman.svg'
import prisma from '@/../public/back/prisma.png'
import typescript from '@/../public/back/typescript.png'
import puppeteer from '@/../public/back/puppeteer.png'
import python from '@/../public/back/python.png'
import typeorm from '@/../public/back/typeorm.png'
...
export default function Home() {
  ...
  switch (true) {
      ...
      return (
        <span key="design" className="min-h-screen flex w-full items-center justify-center flex-col relative">
          <div className='animate-slide-left absolute'>
            <div className='animate-jump-in animate-ease-in'>
              <Image className='animate-wiggle animate-infinite' alt='irineu' src={design} priority />
            </div>
          </div>
          <aside className='pl-[40vw] p-12 animate-fade-right animate-delay-1000 flex flex-col h-full min-h-[50vh] justify-between items-center w-full'>
            <h3 className='text-4xl'>
              Experience
            </h3>
            <div className='animate-delay-1000 animate-jump-in grid grid-cols-3 gap-12 place-items-center'>
    ...
    case (work === 'Front'): {
      return (
        <span key="front" className="min-h-screen flex w-full items-center justify-center">
          ...
          <aside className='pr-[40vw] p-12 animate-fade-right animate-delay-1000 flex flex-col h-full min-h-[50vh] justify-between items-center w-full'>
            <h3 className='text-4xl'>
              Experience
            </h3>
            <div className='animate-delay-1000 animate-jump-in grid grid-cols-3 gap-12 place-items-center'>
    ...
    case (work === 'Backend'): {
      return (
        <section className="min-h-screen grid grid-cols-3 items-center justify-center flex-col place-items-center text-center">
    ...
    default:
      return (
        <>
          ...
          <main className='flex items-center text-dark dark:text-zinc-400 w-full min-h-screen'>
              ...
              <div className='flex items-center justify-between w-full'>
                ...
                <article id='article-about' className='w-1/2 flex flex-col items-center self-center'>
                  <header className='flex'>
                    <AnimatedText Tag='h1' text={text[language]?.title} className='!text-6xl text-left' />
                  </header>
                  <main>
                  ...
                  <footer className='flex items-center self-start mt-2 gap-10'>
                    ...
                    <Link href='mailto:sthivendevelop@gmail.com' className='text-lg font-medium capitalize text-dark dark:text-light underline' >Contact</Link>
                  </footer>
                </article>
              </div>
            </Layout>
