...
export default function AnimatedText({ text, className = '', Tag = 'h2' }: AnimatedTextProps) {
  ...
  return (
    <div className={`w-full mx-auto py-2 flex items-center justify-center text-center overflow-hidden`}>
      <MotionText variants={quote} initial='initial' animate='animate' className={`inline-block w-full text-dark dark:text-zinc-200 font-bold capitalize text-8xl ${className}`}>
        {
